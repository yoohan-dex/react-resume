...
/***/ function(module, exports, __webpack_require__) {
	...
	var _zhCN = __webpack_require__(175);
	
	var _zhCN2 = _interopRequireDefault(_zhCN);
	
	var _resume = __webpack_require__(176);
	
	var _resume2 = _interopRequireDefault(_resume);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var locals = Object.assign({}, _zhCN2.default, _resume2.default);
	...
	function render(meaningless, callback) {
	  var html = _server2.default.renderToStaticMarkup(_react2.default.createElement(_Root2.default, locals));
	...
	var Root = function Root(props) {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement('style', { dangerouslySetInnerHTML: { __html: _index2.default } })
	    ),
	    _react2.default.createElement(
	      'body',
	      null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function Header(props) {
	  var renderContact = function renderContact(contact) {
	    return _react2.default.createElement(_Contact2.default, { type: contact.type, value: contact.value });
	  };
	  return _react2.default.createElement(
	    'header',
	    { className: 'row' },
	...
	Header.propTypes = {
	  ...
	  job_description: _react.PropTypes.array,
	  contact: _react.PropTypes.array
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Contact = function Contact(contact) {
	  switch (contact.type) {
	    case 'email':
	      return _react2.default.createElement(
	        'li',
	    ...
	    case 'github':
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'a',
	          { href: 'http://github.com/' + contact.value },
	    ...
	    case 'weibo':
	      return _react2.default.createElement(
	        'li',
	        { className: 'contact-weibo' },
	        _react2.default.createElement(
	          'a',
	          { href: 'http://weibo.com/' + contact.value },
	          contact.value
	        )
	      );
	    default:
	...
	var Content = function Content(props) {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_Education2.default, { education: props.education })
	    ),
	    _react2.default.createElement(
	      'article',
	      { className: 'col-6 last column' },
	      _react2.default.createElement(
	        'h2',
	        null,
	        'hiosdjfiljdsf'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Education = function Education(props) {
	  ...
	  var section = props.section_names;
	  return _react2.default.createElement(
	    _Section2.default,
	    { timeline: education.timeline, section: section },
	    _react2.default.createElement(
	      'li',
	      _defineProperty({ className: 'timeline-item' }, 'className', 'education-' + education.type),
	      _react2.default.createElement(
	        'h3',
	      ...
	      _react2.default.createElement(
	        'dl',
	        { className: 'education-description timeline-content' },
	        _react2.default.createElement(
	          'dt',
	...
	Education.propTypes = {
	  education: _react.PropTypes.object
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Section = function Section(props) {
	  var content = props.timeline ? _react2.default.createElement(
	    "div",
	    { className: "timeline-wrapper" },
	    _react2.default.createElement(
	      "ul",
	      { className: "sec-content timeline" },
	      props.children
	    )
	  ) : _react2.default.createElement(
	    "div",
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "span",
	          { className: "sec-title-ch" },
	          props.section
	        ),
	        _react2.default.createElement(
	          "span",
	          { className: "sec-title-en" },
	          props.section
	        )
	      ),
	      content
	...
	Section.propTypes = {
	  timeline: _react.PropTypes.string,
	...
	var Footer = function Footer() {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'a',
	        { href: 'http://github.com/yoohan-dex/resume' },
	        'YooHan\'s resume generator'
	      )
	    )
	  );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "a{text-decoration:none;transition:all 0.1s ease-out}a:link{color:#CE5C60}a:visited{color:#CE5C60}a:hover{color:#2B3950}a:active{color:#2B3950}html{margin:0;padding:0}body{color:#2B3950;background-color:#FAFBFC;font-family:\"Open Sans\",\"Helvetica Neue\",Helvetica,Arial,sans-serif;margin:0;padding:0;font-size:16px}h1{font-size:72px}h2{font-size:20.8px}h3{font-size:20px}h4{font-size:16px}h5{font-size:16px}h6{font-size:14px}.contanier{background-color:#FAFBFC;box-shadow:2px 2px 3px rgba(0,0,0,0.3)}strong{font-weight:bold;color:#CE5C60}@media print{.container{width:1000px;margin-top:0;box-shadow:none}body{background:transparent}aside,footer{display:none}}*{box-sizing:border-box}.container{margin-right:auto;margin-left:auto}.row{margin-left:0px;margin-right:0px;overflow:hidden}.col{position:relative;padding-left:15px;padding-right:15px;float:left}.col-1{width:8.33333%}@media print{.col-1{width:25%}}.col-2{width:16.66667%}@media print{.col-2{width:50%}}.col-3{width:25%}@media print{.col-3{width:75%}}.col-4{width:33.33333%}@media print{.col-4{width:100%}}.col-5{width:41.66667%}@media screen and (max-width: 992px){.col-5{width:100%;float:none;padding:0}}.col-6{width:50%}@media screen and (max-width: 992px){.col-6{width:100%;float:none;padding:0}}.col-7{width:58.33333%}@media screen and (max-width: 992px){.col-7{width:100%;float:none;padding:0}}.col-8{width:66.66667%}@media screen and (max-width: 992px){.col-8{width:100%;float:none;padding:0}}.col-9{width:75%}@media screen and (max-width: 992px){.col-9{width:100%;float:none;padding:0}}.col-10{width:83.33333%}@media screen and (max-width: 992px){.col-10{width:100%;float:none;padding:0}}.col-11{width:91.66667%}@media screen and (max-width: 992px){.col-11{width:100%;float:none;padding:0}}.col-12{width:100%}@media screen and (max-width: 992px){.col-12{width:100%;float:none;padding:0}}.first{padding-left:0}.last{padding-right:0}.container{margin-top:10px}@media screen and (max-width: 767px){.container{padding:5px 0;margin-top:0}}@media screen and (min-width: 768px){.container{width:750px}}@media screen and (min-width: 992px){.container{width:970px}}@media screen and (min-width: 1200px){.container{width:1030px}}header,.content{padding:30px 45px}@media screen and (max-width: 767px){header,.content{padding:30px 10px;margin-top:0;margin-bottom:5px}}@media screen and (min-width: 992px){.invisible-lt-sm{display:block}}@media screen and (max-width: 991px){.invisible-lt-sm{display:none}}@media screen and (min-width: 992px){.visible-lt-sm{display:none}}@media screen and (max-width: 991px){.visible-lt-sm{display:block}}@media print{.visible-print{display:block}}@media print{.invisible-print{display:none}}@font-face{font-family:'FontAwesome';src:url(\"/fonts/fontawesome-webfont.eot?v=4.3.0\");src:url(\"/fonts/fontawesome-webfont.eot?#iefix&v=4.3.0\") format(\"embedded-opentype\"),url(\"/fonts/fontawesome-webfont.woff2?v=4.3.0\") format(\"woff2\"),url(\"/fonts/fontawesome-webfont.woff?v=4.3.0\") format(\"woff\"),url(\"/fonts/fontawesome-webfont.ttf?v=4.3.0\") format(\"truetype\"),url(\"/fonts/fontawesome-webfont.svg?v=4.3.0#fontawesomeregular\") format(\"svg\");font-weight:normal;font-style:normal}.contact-github{padding-left:28px}.contact-github:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\\F092\";width:28px;margin-left:-28px;display:inline-block}.contact-rss{padding-left:28px}.contact-rss:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\\F09E\";width:28px;margin-left:-28px;display:inline-block}.contact-phone{padding-left:28px}.contact-phone:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\\F095\";width:28px;margin-left:-28px;display:inline-block}.contact-envelope{padding-left:28px}.contact-envelope:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\\F0E0\";width:28px;margin-left:-28px;display:inline-block}.contact-wechat{padding-left:28px}.contact-wechat:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\\F1D7\";width:28px;margin-left:-28px;display:inline-block}.contact-weibo{padding-left:28px}.contact-weibo:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\\F18A\";width:28px;margin-left:-28px;display:inline-block}header{padding-bottom:6px;background-color:#2B3950;color:white}.title{float:right;text-align:right;margin:0}@media screen and (max-width: 767px){.title{float:none;text-align:center}}.title h1,.title h2{margin:5px 0;line-height:1}.title h1{padding:5px 0;color:#FAFBFC}.title h2{padding:5px 6px;font-weight:normal}header .contact{float:left;margin:0;padding-left:16px}@media print and (max-width: 767px){header .contact{float:none;margin-top:10px;padding-left:5px}}header .contact li{list-style-type:none;font-style:normal;line-height:1.4;font-size:18px;word-break:break-all}header a:link,header a:visited{color:#FAFBFC}header a:hover,header a:active{color:#999EAC}footer{text-align:center;margin:30px 6px}section{margin-bottom:14px}.sec-title-wrapper{overflow-y:hidden;zoom:1}.sec-title{float:left;padding:0;margin:0 0 0 10px;overflow-y:hidden;zoom:1}.sec-title-ch{font-size:20px;float:left;font-weight:bold}.sec-title-en{font-size:16px;float:left;clear:left;color:#CE5C60;font-variant:small-caps;font-weight:bold}.sec-title-wrapper::before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);background-color:#2B3950;color:#FAFBFC;border-radius:100%;float:left;width:32px;height:32px;padding:6px;text-align:center;line-height:32px;font-size:26px;content:\"\\F092\"}.education-name{font-size:32px;font-weight:bold;margin:10px 0 5px 0}.education-major,.education-honor{list-style-type:none;line-height:1.42857;margin:0;padding:0}.education .sec-title-wrapper::before{content:\"\\F02D\"}.education-major{padding-left:28px}.education-major:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\\F19D\";width:28px;margin-left:-28px;display:inline-block}.education-honor{padding-left:28px}.education-honor:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\\F091\";width:28px;margin-left:-28px;display:inline-block}\n", "", {"version":3,"sources":["/./app/sass/index.scss","/./app/sass/app/sass/utils/global.scss","/./app/sass/app/sass/utils/theme.scss","/./app/sass/app/sass/utils/variables.scss","/./app/sass/app/sass/utils/print.scss","/./app/sass/app/sass/utils/layout.scss","/./app/sass/app/sass/utils/responsive.scss","/./app/sass/app/sass/utils/icons.scss","/./app/sass/app/sass/wheels/contact.scss","/./app/sass/app/sass/utils/icon-alias.scss","/./app/sass/app/sass/components/header.scss","/./app/sass/app/sass/components/footer.scss","/./app/sass/app/sass/components/section.scss","/./app/sass/app/sass/components/education.scss"],"names":[],"mappings":"AAAA,EAAE,qBCCiB,4BACL,CAAA,OAFb,aCAK,CAAA,UDAL,aCAK,CAAA,QDAL,aCEW,CAAA,SDFX,aCEW,CAAA,KDaT,SAIK,SACN,CAAO,KACR,cCnBW,yBAGC,oECc6D,SFOlE,UACC,cEpBS,CAAA,GFsBjB,cEjBiB,CAAA,GFmBc,gBElBd,CAAA,GFmBc,cElBd,CAAA,GFmBc,cE1Bd,CAAA,GF2Bc,cE3Bd,CAAA,GF4Bc,cElBd,CAAA,WFmBc,yBC/BnB,sCDmCa,CAAA,OACzB,iBAGc,aC5CT,CAAA,aEAN,WACE,aACS,aACG,eACE,CAAA,KACb,sBAGa,CAAA,aAGP,YACI,CAAA,CAAA,EACV,qBCZW,CAAA,WACb,kBAGe,gBACD,CAAA,KACd,gBAEc,iBACC,eACJ,CAAA,KACX,kBAEW,kBACK,mBACC,UACT,CAAA,OACR,cAKU,CAAA,aAWL,OAZJ,SAaa,CAAA,CAAA,OAbb,eACS,CAAA,aAWL,OAZJ,SAaa,CAAA,CAAA,OAbb,SACS,CAAA,aAWL,OAZJ,SAaa,CAAA,CAAA,OAbb,eACS,CAAA,aAWL,OAZJ,UAaa,CAAA,CAAA,OAbb,eACS,CAAA,qCAGS,OAJlB,WAKgB,WACA,SACR,CAAO,CAAG,OAPlB,SACS,CAAA,qCAGS,OAJlB,WAKgB,WACA,SACR,CAAO,CAAG,OAPlB,eACS,CAAA,qCAGS,OAJlB,WAKgB,WACA,SACR,CAAO,CAAG,OAPlB,eACS,CAAA,qCAGS,OAJlB,WAKgB,WACA,SACR,CAAO,CAAG,OAPlB,SACS,CAAA,qCAGS,OAJlB,WAKgB,WACA,SACR,CAAO,CAAG,QAPlB,eACS,CAAA,qCAGS,QAJlB,WAKgB,WACA,SACR,CAAO,CAAG,QAPlB,eACS,CAAA,qCAGS,QAJlB,WAKgB,WACA,SACR,CAAO,CAAG,QAPlB,UACS,CAAA,qCAGS,QAJlB,WAKgB,WACA,SACR,CAAO,CAAG,OAYpB,cACG,CAAY,MACd,eAGE,CAAa,WACf,eF+BwB,CAAA,qCG3EA,WAHzB,cHoF4B,YG/ExB,CAAU,CAAE,qCAGS,WARzB,WH8DqB,CAAA,CAAA,qCGlDI,WAZzB,WHiEsB,CAAA,CAAA,sCGjDG,WAhBzB,YHoE4B,CAAA,CAAA,gBG/CpB,iBHsEuB,CAAA,qCGlER,gBACb,kBH2DiB,aGzDb,iBHwDW,CAAA,CAAA,qCGnDE,iBAD3B,aAEiB,CAAA,CAAA,qCAEU,iBAJ3B,YAKiB,CAAA,CAAA,qCAKU,eAD3B,YAEiB,CAAA,CAAA,qCAEU,eAJ3B,aAKiB,CAAA,CAAA,aAKf,eADF,aAEa,CAAA,CAAA,aAKX,iBADF,YAEa,CAAA,CAAA,WCXb,0BACe,kDACR,mWAKiF,mBACzE,iBACD,CAAA,gBC/CZ,iBDuBgB,CAAA,uBAEf,wBAjCY,kBACF,oBACK,yBACA,yBACN,gBEoPW,WFpNZ,kBACM,oBACJ,CAAA,aACV,iBARa,CAAE,oBAEf,wBAjCY,kBACF,oBACK,yBACA,yBACN,gBA+BD,WACP,kBACW,oBACF,CAAA,eACV,iBARC,CAAA,sBAED,wBAjCY,kBACF,oBACX,yBACgB,yBACN,gBA+BR,WACA,kBACA,oBACS,CAAA,kBACV,iBARC,CAAA,yBCvBF,wBDRa,kBACJ,oBACT,yBACgB,yBACN,gBA+BR,WACA,kBACA,oBACS,CAAA,gBACV,iBARC,CAAA,uBCvBF,wBDRa,kBACb,oBACA,yBACc,yBACJ,gBA+BR,WE6hBY,kBF3hBZ,oBACO,CAAE,eACV,iBARC,CAAA,sBCvBF,wBDRW,kBACX,oBACA,yBACA,yBACU,gBAAS,WE2jBN,kBF1hBX,oBACA,CAAA,OAAS,mBGtCT,yBACA,WRAQ,CAAA,OQCR,YACH,iBAIG,QAAU,CAAE,qCAGA,OAAS,WALzB,iBAOM,CAAA,CAAA,oBAIN,aAAkB,aACkB,CAAC,UACjC,cAGK,aAC4B,CAAC,URlBzB,gBQuBT,kBACA,CAAA,gBACH,WAGM,SACE,iBAEL,CAAA,oCACW,gBAJf,WAAO,gBAMD,gBACA,CAAA,CAAA,mBAIN,qBACI,kBACA,gBACA,eACA,oBACA,CAAA,+BAGW,aAAQ,CAAQ,+BAKf,aAAQ,CAAO,ORrDlB,kBSHT,eACA,CAAA,QRwFyB,kBStF3B,CAAA,mBACD,kBP6CG,MAAA,CAAU,WACV,WO1CH,UAGQ,kBAEP,kBPoCE,MAAA,CAAU,cACF,eOhCV,WTVgB,gBSYhB,CAAA,cAAkB,eAIlB,WTlBgB,WSmBT,cACK,wBAEZ,gBACA,CAAA,2BACD,wBL9BC,kBACA,oBACA,yBACA,yBACU,yBAKV,cLRiB,mBKWjB,WJwFqB,WIvFd,YKdO,YAAA,kBLoBd,iBACA,eAEA,eAAW,CAAA,gBEkOiB,eGnN7B,iBCpCC,mBACA,CAAA,kCAIF,qBACE,oBACA,SVciB,SUbjB,CAAA,sCD8BW,eAAkB,CAAA,iBHwBjB,iBGtBX,CC3Ba,wBAAhB,wBNdE,kBAAyB,oBAEzB,yBACA,yBACA,gBAAU,WA+BR,kBACO,oBACO,CACd,iBAAS,iBACV,CAAA,wBMtBH,wBNjBE,kBAAa,oBACM,yBAEnB,yBACA,gBAAU,WA+BR,kBACO,oBACM,CAAA","file":"index.scss","sourcesContent":["a{text-decoration:none;transition:all 0.1s ease-out}a:link{color:#CE5C60}a:visited{color:#CE5C60}a:hover{color:#2B3950}a:active{color:#2B3950}html{margin:0;padding:0}body{color:#2B3950;background-color:#FAFBFC;font-family:\"Open Sans\",\"Helvetica Neue\",Helvetica,Arial,sans-serif;margin:0;padding:0;font-size:16px}h1{font-size:72px}h2{font-size:20.8px}h3{font-size:20px}h4{font-size:16px}h5{font-size:16px}h6{font-size:14px}.contanier{background-color:#FAFBFC;box-shadow:2px 2px 3px rgba(0,0,0,0.3)}strong{font-weight:bold;color:#CE5C60}@media print{.container{width:1000px;margin-top:0;box-shadow:none}body{background:transparent}aside,footer{display:none}}*{box-sizing:border-box}.container{margin-right:auto;margin-left:auto}.row{margin-left:0px;margin-right:0px;overflow:hidden}.col{position:relative;padding-left:15px;padding-right:15px;float:left}.col-1{width:8.33333%}@media print{.col-1{width:25%}}.col-2{width:16.66667%}@media print{.col-2{width:50%}}.col-3{width:25%}@media print{.col-3{width:75%}}.col-4{width:33.33333%}@media print{.col-4{width:100%}}.col-5{width:41.66667%}@media screen and (max-width: 992px){.col-5{width:100%;float:none;padding:0}}.col-6{width:50%}@media screen and (max-width: 992px){.col-6{width:100%;float:none;padding:0}}.col-7{width:58.33333%}@media screen and (max-width: 992px){.col-7{width:100%;float:none;padding:0}}.col-8{width:66.66667%}@media screen and (max-width: 992px){.col-8{width:100%;float:none;padding:0}}.col-9{width:75%}@media screen and (max-width: 992px){.col-9{width:100%;float:none;padding:0}}.col-10{width:83.33333%}@media screen and (max-width: 992px){.col-10{width:100%;float:none;padding:0}}.col-11{width:91.66667%}@media screen and (max-width: 992px){.col-11{width:100%;float:none;padding:0}}.col-12{width:100%}@media screen and (max-width: 992px){.col-12{width:100%;float:none;padding:0}}.first{padding-left:0}.last{padding-right:0}.container{margin-top:10px}@media screen and (max-width: 767px){.container{padding:5px 0;margin-top:0}}@media screen and (min-width: 768px){.container{width:750px}}@media screen and (min-width: 992px){.container{width:970px}}@media screen and (min-width: 1200px){.container{width:1030px}}header,.content{padding:30px 45px}@media screen and (max-width: 767px){header,.content{padding:30px 10px;margin-top:0;margin-bottom:5px}}@media screen and (min-width: 992px){.invisible-lt-sm{display:block}}@media screen and (max-width: 991px){.invisible-lt-sm{display:none}}@media screen and (min-width: 992px){.visible-lt-sm{display:none}}@media screen and (max-width: 991px){.visible-lt-sm{display:block}}@media print{.visible-print{display:block}}@media print{.invisible-print{display:none}}@font-face{font-family:'FontAwesome';src:url(\"/fonts/fontawesome-webfont.eot?v=4.3.0\");src:url(\"/fonts/fontawesome-webfont.eot?#iefix&v=4.3.0\") format(\"embedded-opentype\"),url(\"/fonts/fontawesome-webfont.woff2?v=4.3.0\") format(\"woff2\"),url(\"/fonts/fontawesome-webfont.woff?v=4.3.0\") format(\"woff\"),url(\"/fonts/fontawesome-webfont.ttf?v=4.3.0\") format(\"truetype\"),url(\"/fonts/fontawesome-webfont.svg?v=4.3.0#fontawesomeregular\") format(\"svg\");font-weight:normal;font-style:normal}.contact-github{padding-left:28px}.contact-github:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\";width:28px;margin-left:-28px;display:inline-block}.contact-rss{padding-left:28px}.contact-rss:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\";width:28px;margin-left:-28px;display:inline-block}.contact-phone{padding-left:28px}.contact-phone:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\";width:28px;margin-left:-28px;display:inline-block}.contact-envelope{padding-left:28px}.contact-envelope:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\";width:28px;margin-left:-28px;display:inline-block}.contact-wechat{padding-left:28px}.contact-wechat:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\";width:28px;margin-left:-28px;display:inline-block}.contact-weibo{padding-left:28px}.contact-weibo:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\";width:28px;margin-left:-28px;display:inline-block}header{padding-bottom:6px;background-color:#2B3950;color:white}.title{float:right;text-align:right;margin:0}@media screen and (max-width: 767px){.title{float:none;text-align:center}}.title h1,.title h2{margin:5px 0;line-height:1}.title h1{padding:5px 0;color:#FAFBFC}.title h2{padding:5px 6px;font-weight:normal}header .contact{float:left;margin:0;padding-left:16px}@media print and (max-width: 767px){header .contact{float:none;margin-top:10px;padding-left:5px}}header .contact li{list-style-type:none;font-style:normal;line-height:1.4;font-size:18px;word-break:break-all}header a:link,header a:visited{color:#FAFBFC}header a:hover,header a:active{color:#999EAC}footer{text-align:center;margin:30px 6px}section{margin-bottom:14px}.sec-title-wrapper{overflow-y:hidden;zoom:1}.sec-title{float:left;padding:0;margin:0 0 0 10px;overflow-y:hidden;zoom:1}.sec-title-ch{font-size:20px;float:left;font-weight:bold}.sec-title-en{font-size:16px;float:left;clear:left;color:#CE5C60;font-variant:small-caps;font-weight:bold}.sec-title-wrapper::before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);background-color:#2B3950;color:#FAFBFC;border-radius:100%;float:left;width:32px;height:32px;padding:6px;text-align:center;line-height:32px;font-size:26px;content:\"\"}.education-name{font-size:32px;font-weight:bold;margin:10px 0 5px 0}.education-major,.education-honor{list-style-type:none;line-height:1.42857;margin:0;padding:0}.education .sec-title-wrapper::before{content:\"\"}.education-major{padding-left:28px}.education-major:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\";width:28px;margin-left:-28px;display:inline-block}.education-honor{padding-left:28px}.education-honor:before{font-family:FontAwesome;font-size:inherit;text-rendering:auto;font-smoothing:grayscale;tansform:translate(0, 0);content:\"\";width:28px;margin-left:-28px;display:inline-block}\n","a {\n  text-decoration: none;\n  transition: all 0.1s ease-out;\n\n  &:link {\n    color: $link-color;\n  }\n  &:visited {\n    color: $link-color;\n  }\n  &:hover {\n    color: $text-color;\n  }\n  &:active {\n    color: $text-color;\n  }\n}\n\nhtml {\n  margin: 0;\n  padding: 0;\n}\nbody {\n  color: $text-color;\n  background-color: $bg-color;\n  font-family: $font-family-sans-serif;\n  margin: 0;\n  padding: 0;\n  font-size: $font-size-base;\n}\n\nh1 { font-size: $font-size-h1;}\nh2 { font-size: $font-size-h2;}\nh3 { font-size: $font-size-h3;}\nh4 { font-size: $font-size-h4;}\nh5 { font-size: $font-size-h5;}\nh6 { font-size: $font-size-h6;}\n\n.contanier {\n  background-color: $easy-white;\n  box-shadow: 2px 2px 3px rgba(0,0,0,0.3);\n}\n\nstrong {\n  font-weight: bold;\n  color: $bright-color;\n}\n","$red: #CE5C60;\n$gray: #525A6F;\n$font-gray: #2B3950;\n$theme-color: #6C7888;\n$light-gray: #999EAC;\n$easy-white: #FAFBFC;\n\n$bright-color: $red;\n$bright-contrast-color: $gray;\n$dark-color: $font-gray;\n$light-color: $light-gray;\n","$link-color: $bright-color;\n$link-hover-color: $bright-contrast-color;\n$light-shadow: 2px 2px 3px rgba(0, 0, 0, 0.2);\n\n\n$text-color: $font-gray;\n$bg-color: $easy-white;\n$font-size-base:  16px;\n$font-size-huge: $font-size-base * 2;\n$font-size-large: $font-size-base * 1.25;\n$font-size-medium: $font-size-base * 1.125;\n$font-size-small: $font-size-base * 0.875;\n$font-size-h1:    $font-size-base * 4.5;\n$font-size-h2:    $font-size-base * 1.3;\n$font-size-h3:    $font-size-base * 1.25;\n$font-size-h4:    $font-size-base;\n$font-size-h5:    $font-size-base;\n$font-size-h6:    $font-size-base * 0.875; // 14px\n\n$font-family-sans-serif: \"Open Sans\", \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n$font-family-monospace:  Monaco, Consolas, \"Courier New\", monospace;\n$font-family-serif:      Georgia, \"Times New Roman\", Times, serif;\n\n$line-height-base: 1.428571429; // 20/14\n// Computed \"line-height\" (`font-size` * `line-height`) for use with `margin`, `padding`, etc.\n$line-height-computed: floor(($font-size-base * $line-height-base)); // ~20px\n// By default, this inherits from the `<body>`.\n$headings-font-family: inherit;\n$headings-font-weight: 500;\n$headings-line-height: 1.1;\n$headings-color: inherit;\n\n//== Media queries breakpoints\n// --------------------------------------------------\n// Small screen / tablet\n$screen-sm: 768px;\n$screen-sm-min: $screen-sm;\n$screen-tablet: $screen-sm-min;\n// Medium screen / desktop\n$screen-md: 992px;\n$screen-md-min: $screen-md;\n$screen-desktop: $screen-md-min;\n// Large screen / wide desktop\n$screen-lg: 1200px;\n$screen-lg-min: $screen-lg;\n$screen-lg-desktop: $screen-lg-min;\n// So media queries don't overlap when required, provide a maximum\n$screen-xs-max: ($screen-sm-min - 1);\n$screen-sm-max: ($screen-md-min - 1);\n$screen-md-max: ($screen-lg-min - 1);\n\n//= Grid system\n// --------------------------------------------------\n// Number of columns in the grid system\n$grid-columns: 12;\n// Padding, to be divided by two and applied to the left and right of all columns\n$grid-gutter-width: 30px;\n$grid-float-breakpoint: $screen-md-min;\n$grid-columns-breakpoint: 4;\n\n//= Container sizes\n// Small screen / tablet\n$container-tablet: ((720px + $grid-gutter-width));\n$container-sm: $container-tablet;\n// Medium screen / desktop\n$container-desktop: ((940px + $grid-gutter-width));\n$container-md: $container-desktop;\n// Large screen / wide desktop\n$container-large-desktop: ((1000px + $grid-gutter-width));\n$container-lg: $container-large-desktop;\n\n//== Components\n//\n// Define common padding and border radius sizes and more.\n// Values based on 14px text and 1.428 line-height (~20px to start).\n$padding-base-vertical: 6px;\n$padding-base-horizontal: 12px;\n\n$padding-large-vertical: 10px;\n$padding-large-horizontal: 16px;\n\n$padding-huge-vertical: 14px;\n$padding-huge-horizontal: 20px;\n\n$padding-small-vertical: 5px;\n$padding-small-horizontal: 10px;\n\n$padding-xs-vertical: 1px;\n$padding-xs-horizontal: 5px;\n\n$padding-container-vertical: 30px;\n$padding-container-horizontal: $padding-container-vertical + ($grid-gutter-width / 2);\n\n\n$line-height-large: 1.33;\n$line-height-small: 1.5;\n\n$border-radius-base: 4px;\n$border-radius-large: 6px;\n$border-radius-small: 3px;\n$border-radius-huge: 10px;\n$border-radius-circle: 100%;\n\n$border-divide: 2px solid $text-color;\n\n//icons\n$fa-font-path:       \"/fonts\";\n$fa-font-size-base:   14px;\n$fa-css-prefix:       fa;\n$fa-version:          \"4.3.0\";\n$fa-font-size-base:   14px;\n\n//== Section\n\n\n","@media print {\n  .container {\n    width: 1000px;\n    margin-top: 0;\n    box-shadow: none;\n  }\n\n  body {\n    background: transparent;\n  }\n\n  aside, footer {\n    display: none;\n  }\n\n}\n","* {\n  box-sizing: border-box;\n}\n\n.container {\n  margin-right: auto;\n  margin-left: auto;\n}\n.row {\n  margin-left: 0px;\n  margin-right: 0px;\n  overflow: hidden;\n}\n.col {\n  position: relative;\n  padding-left: ($grid-gutter-width / 2);\n  padding-right: ($grid-gutter-width /2);\n  float: left;\n}\n\n//col-1 to col-12 \n@for $index from 1 through $grid-columns{\n  .col-#{$index}{\n    width: percentage($index / $grid-columns);\n    @if $index > $grid-columns-breakpoint{\n      @media screen {\n        @media (max-width: $grid-float-breakpoint){\n          width : 100%;\n          float : none;\n          padding : 0;\n        }\n      } \n    }\n    @if $index <= $grid-columns-breakpoint{\n      @media print {\n        width: percentage($index / $grid-columns-breakpoint);\n      }\n    }\n  }\n}\n\n.first {\n   padding-left: 0;\n}\n\n.last {\n   padding-right: 0;\n}\n\n@mixin float-container {\n    overflow-y: hidden;\n    zoom: 1;\n}\n\n\n",".container { \n  margin-top: $padding-large-vertical;\n\n  @media screen and (max-width: $screen-xs-max) {\n    padding: $padding-small-vertical 0;\n    margin-top: 0;\n  }\n\n  @media screen and (min-width: $screen-sm-min) {\n    width: $container-sm;\n  }\n\n  @media screen and (min-width: $screen-md-min) {\n    width: $container-md;\n  }\n\n  @media screen and (min-width: $screen-lg-min) {\n    width: $container-lg;\n  }\n}\n\nheader, .content {\n  padding: $padding-container-vertical $padding-container-horizontal;\n}\n\n@media screen and (max-width: $screen-xs-max) {\n  header, .content {\n    padding: $padding-container-vertical $padding-small-horizontal;\n    margin-top: 0;\n    margin-bottom: $padding-small-vertical;\n  }\n}\n.invisible-lt-sm {\n    @media screen and (min-width: $screen-md-min) {\n        display: block;\n    }\n    @media screen and (max-width: $screen-sm-max) {\n        display: none;\n    }\n}\n\n.visible-lt-sm {\n    @media screen and (min-width: $screen-md-min) {\n        display: none;\n    }\n    @media screen and (max-width: $screen-sm-max) {\n        display: block;\n    }\n}\n\n.visible-print {\n  @media print {\n    display: block;\n  }\n}\n\n.invisible-print {\n  @media print {\n    display: none;\n  }\n} ","@mixin fa {\n  font-family: FontAwesome;\n  font-size: inherit;\n  text-rendering: auto;\n  font-smoothing: grayscale;\n  tansform: translate(0,0);\n}\n\n@mixin fa-icon($size, $padding, $background, $foreground : $easy-white){\n  @include fa;\n  background-color: $background;\n  color: $foreground;\n\n  border-radius: $border-radius-circle;\n  float: left;\n\n  width: $size;\n  height: $size;\n  padding: $padding;\n\n  text-align: center;\n  line-height: $size;\n\n  font-size: $size - $padding;\n}\n@mixin fa-li {\n  @include fa;\n  padding-right: $padding-large-horizontal;\n} \n\n@mixin set-li-icon ($icon){\n  \n    padding-left: $padding-base-horizontal + $font-size-base;\n  \n  &:before{\n    @include fa;\n    content: $icon;\n    width: $padding-base-horizontal + $font-size-base;\n    margin-left: -$padding-base-horizontal - $font-size-base;\n    display: inline-block;\n  }\n}\n\n\n\n\n\n@font-face {\n  font-family: 'FontAwesome';\n  src: url('#{$fa-font-path}/fontawesome-webfont.eot?v=#{$fa-version}');\n  src: url('#{$fa-font-path}/fontawesome-webfont.eot?#iefix&v=#{$fa-version}') format('embedded-opentype'),\n    url('#{$fa-font-path}/fontawesome-webfont.woff2?v=#{$fa-version}') format('woff2'),\n    url('#{$fa-font-path}/fontawesome-webfont.woff?v=#{$fa-version}') format('woff'),\n    url('#{$fa-font-path}/fontawesome-webfont.ttf?v=#{$fa-version}') format('truetype'),\n    url('#{$fa-font-path}/fontawesome-webfont.svg?v=#{$fa-version}#fontawesomeregular') format('svg');\n  font-weight: normal;\n  font-style: normal;\n}\n\n","$contact-map: (\n  github: $fa-var-github-square,\n  rss: $fa-var-rss,\n  phone: $fa-var-phone,\n  envelope: $fa-var-envelope,\n  wechat: $fa-var-weixin,\n  weibo: $fa-var-weibo\n  );\n@each $type, $icon in $contact-map {\n  .contact-#{$type} {\n    @include set-li-icon($icon);\n  }\n}","$fa-var-adjust: \"\\f042\";\n$fa-var-adn: \"\\f170\";\n$fa-var-align-center: \"\\f037\";\n$fa-var-align-justify: \"\\f039\";\n$fa-var-align-left: \"\\f036\";\n$fa-var-align-right: \"\\f038\";\n$fa-var-ambulance: \"\\f0f9\";\n$fa-var-anchor: \"\\f13d\";\n$fa-var-android: \"\\f17b\";\n$fa-var-angellist: \"\\f209\";\n$fa-var-angle-double-down: \"\\f103\";\n$fa-var-angle-double-left: \"\\f100\";\n$fa-var-angle-double-right: \"\\f101\";\n$fa-var-angle-double-up: \"\\f102\";\n$fa-var-angle-down: \"\\f107\";\n$fa-var-angle-left: \"\\f104\";\n$fa-var-angle-right: \"\\f105\";\n$fa-var-angle-up: \"\\f106\";\n$fa-var-apple: \"\\f179\";\n$fa-var-archive: \"\\f187\";\n$fa-var-area-chart: \"\\f1fe\";\n$fa-var-arrow-circle-down: \"\\f0ab\";\n$fa-var-arrow-circle-left: \"\\f0a8\";\n$fa-var-arrow-circle-o-down: \"\\f01a\";\n$fa-var-arrow-circle-o-left: \"\\f190\";\n$fa-var-arrow-circle-o-right: \"\\f18e\";\n$fa-var-arrow-circle-o-up: \"\\f01b\";\n$fa-var-arrow-circle-right: \"\\f0a9\";\n$fa-var-arrow-circle-up: \"\\f0aa\";\n$fa-var-arrow-down: \"\\f063\";\n$fa-var-arrow-left: \"\\f060\";\n$fa-var-arrow-right: \"\\f061\";\n$fa-var-arrow-up: \"\\f062\";\n$fa-var-arrows: \"\\f047\";\n$fa-var-arrows-alt: \"\\f0b2\";\n$fa-var-arrows-h: \"\\f07e\";\n$fa-var-arrows-v: \"\\f07d\";\n$fa-var-asterisk: \"\\f069\";\n$fa-var-at: \"\\f1fa\";\n$fa-var-automobile: \"\\f1b9\";\n$fa-var-backward: \"\\f04a\";\n$fa-var-ban: \"\\f05e\";\n$fa-var-bank: \"\\f19c\";\n$fa-var-bar-chart: \"\\f080\";\n$fa-var-bar-chart-o: \"\\f080\";\n$fa-var-barcode: \"\\f02a\";\n$fa-var-bars: \"\\f0c9\";\n$fa-var-bed: \"\\f236\";\n$fa-var-beer: \"\\f0fc\";\n$fa-var-behance: \"\\f1b4\";\n$fa-var-behance-square: \"\\f1b5\";\n$fa-var-bell: \"\\f0f3\";\n$fa-var-bell-o: \"\\f0a2\";\n$fa-var-bell-slash: \"\\f1f6\";\n$fa-var-bell-slash-o: \"\\f1f7\";\n$fa-var-bicycle: \"\\f206\";\n$fa-var-binoculars: \"\\f1e5\";\n$fa-var-birthday-cake: \"\\f1fd\";\n$fa-var-bitbucket: \"\\f171\";\n$fa-var-bitbucket-square: \"\\f172\";\n$fa-var-bitcoin: \"\\f15a\";\n$fa-var-bold: \"\\f032\";\n$fa-var-bolt: \"\\f0e7\";\n$fa-var-bomb: \"\\f1e2\";\n$fa-var-book: \"\\f02d\";\n$fa-var-bookmark: \"\\f02e\";\n$fa-var-bookmark-o: \"\\f097\";\n$fa-var-briefcase: \"\\f0b1\";\n$fa-var-btc: \"\\f15a\";\n$fa-var-bug: \"\\f188\";\n$fa-var-building: \"\\f1ad\";\n$fa-var-building-o: \"\\f0f7\";\n$fa-var-bullhorn: \"\\f0a1\";\n$fa-var-bullseye: \"\\f140\";\n$fa-var-bus: \"\\f207\";\n$fa-var-buysellads: \"\\f20d\";\n$fa-var-cab: \"\\f1ba\";\n$fa-var-calculator: \"\\f1ec\";\n$fa-var-calendar: \"\\f073\";\n$fa-var-calendar-o: \"\\f133\";\n$fa-var-camera: \"\\f030\";\n$fa-var-camera-retro: \"\\f083\";\n$fa-var-car: \"\\f1b9\";\n$fa-var-caret-down: \"\\f0d7\";\n$fa-var-caret-left: \"\\f0d9\";\n$fa-var-caret-right: \"\\f0da\";\n$fa-var-caret-square-o-down: \"\\f150\";\n$fa-var-caret-square-o-left: \"\\f191\";\n$fa-var-caret-square-o-right: \"\\f152\";\n$fa-var-caret-square-o-up: \"\\f151\";\n$fa-var-caret-up: \"\\f0d8\";\n$fa-var-cart-arrow-down: \"\\f218\";\n$fa-var-cart-plus: \"\\f217\";\n$fa-var-cc: \"\\f20a\";\n$fa-var-cc-amex: \"\\f1f3\";\n$fa-var-cc-discover: \"\\f1f2\";\n$fa-var-cc-mastercard: \"\\f1f1\";\n$fa-var-cc-paypal: \"\\f1f4\";\n$fa-var-cc-stripe: \"\\f1f5\";\n$fa-var-cc-visa: \"\\f1f0\";\n$fa-var-certificate: \"\\f0a3\";\n$fa-var-chain: \"\\f0c1\";\n$fa-var-chain-broken: \"\\f127\";\n$fa-var-check: \"\\f00c\";\n$fa-var-check-circle: \"\\f058\";\n$fa-var-check-circle-o: \"\\f05d\";\n$fa-var-check-square: \"\\f14a\";\n$fa-var-check-square-o: \"\\f046\";\n$fa-var-chevron-circle-down: \"\\f13a\";\n$fa-var-chevron-circle-left: \"\\f137\";\n$fa-var-chevron-circle-right: \"\\f138\";\n$fa-var-chevron-circle-up: \"\\f139\";\n$fa-var-chevron-down: \"\\f078\";\n$fa-var-chevron-left: \"\\f053\";\n$fa-var-chevron-right: \"\\f054\";\n$fa-var-chevron-up: \"\\f077\";\n$fa-var-child: \"\\f1ae\";\n$fa-var-circle: \"\\f111\";\n$fa-var-circle-o: \"\\f10c\";\n$fa-var-circle-o-notch: \"\\f1ce\";\n$fa-var-circle-thin: \"\\f1db\";\n$fa-var-clipboard: \"\\f0ea\";\n$fa-var-clock-o: \"\\f017\";\n$fa-var-close: \"\\f00d\";\n$fa-var-cloud: \"\\f0c2\";\n$fa-var-cloud-download: \"\\f0ed\";\n$fa-var-cloud-upload: \"\\f0ee\";\n$fa-var-cny: \"\\f157\";\n$fa-var-code: \"\\f121\";\n$fa-var-code-fork: \"\\f126\";\n$fa-var-codepen: \"\\f1cb\";\n$fa-var-coffee: \"\\f0f4\";\n$fa-var-cog: \"\\f013\";\n$fa-var-cogs: \"\\f085\";\n$fa-var-columns: \"\\f0db\";\n$fa-var-comment: \"\\f075\";\n$fa-var-comment-o: \"\\f0e5\";\n$fa-var-comments: \"\\f086\";\n$fa-var-comments-o: \"\\f0e6\";\n$fa-var-compass: \"\\f14e\";\n$fa-var-compress: \"\\f066\";\n$fa-var-connectdevelop: \"\\f20e\";\n$fa-var-copy: \"\\f0c5\";\n$fa-var-copyright: \"\\f1f9\";\n$fa-var-credit-card: \"\\f09d\";\n$fa-var-crop: \"\\f125\";\n$fa-var-crosshairs: \"\\f05b\";\n$fa-var-css3: \"\\f13c\";\n$fa-var-cube: \"\\f1b2\";\n$fa-var-cubes: \"\\f1b3\";\n$fa-var-cut: \"\\f0c4\";\n$fa-var-cutlery: \"\\f0f5\";\n$fa-var-dashboard: \"\\f0e4\";\n$fa-var-dashcube: \"\\f210\";\n$fa-var-database: \"\\f1c0\";\n$fa-var-dedent: \"\\f03b\";\n$fa-var-delicious: \"\\f1a5\";\n$fa-var-desktop: \"\\f108\";\n$fa-var-deviantart: \"\\f1bd\";\n$fa-var-diamond: \"\\f219\";\n$fa-var-digg: \"\\f1a6\";\n$fa-var-dollar: \"\\f155\";\n$fa-var-dot-circle-o: \"\\f192\";\n$fa-var-download: \"\\f019\";\n$fa-var-dribbble: \"\\f17d\";\n$fa-var-dropbox: \"\\f16b\";\n$fa-var-drupal: \"\\f1a9\";\n$fa-var-edit: \"\\f044\";\n$fa-var-eject: \"\\f052\";\n$fa-var-ellipsis-h: \"\\f141\";\n$fa-var-ellipsis-v: \"\\f142\";\n$fa-var-empire: \"\\f1d1\";\n$fa-var-envelope: \"\\f0e0\";\n$fa-var-envelope-o: \"\\f003\";\n$fa-var-envelope-square: \"\\f199\";\n$fa-var-eraser: \"\\f12d\";\n$fa-var-eur: \"\\f153\";\n$fa-var-euro: \"\\f153\";\n$fa-var-exchange: \"\\f0ec\";\n$fa-var-exclamation: \"\\f12a\";\n$fa-var-exclamation-circle: \"\\f06a\";\n$fa-var-exclamation-triangle: \"\\f071\";\n$fa-var-expand: \"\\f065\";\n$fa-var-external-link: \"\\f08e\";\n$fa-var-external-link-square: \"\\f14c\";\n$fa-var-eye: \"\\f06e\";\n$fa-var-eye-slash: \"\\f070\";\n$fa-var-eyedropper: \"\\f1fb\";\n$fa-var-facebook: \"\\f09a\";\n$fa-var-facebook-f: \"\\f09a\";\n$fa-var-facebook-official: \"\\f230\";\n$fa-var-facebook-square: \"\\f082\";\n$fa-var-fast-backward: \"\\f049\";\n$fa-var-fast-forward: \"\\f050\";\n$fa-var-fax: \"\\f1ac\";\n$fa-var-female: \"\\f182\";\n$fa-var-fighter-jet: \"\\f0fb\";\n$fa-var-file: \"\\f15b\";\n$fa-var-file-archive-o: \"\\f1c6\";\n$fa-var-file-audio-o: \"\\f1c7\";\n$fa-var-file-code-o: \"\\f1c9\";\n$fa-var-file-excel-o: \"\\f1c3\";\n$fa-var-file-image-o: \"\\f1c5\";\n$fa-var-file-movie-o: \"\\f1c8\";\n$fa-var-file-o: \"\\f016\";\n$fa-var-file-pdf-o: \"\\f1c1\";\n$fa-var-file-photo-o: \"\\f1c5\";\n$fa-var-file-picture-o: \"\\f1c5\";\n$fa-var-file-powerpoint-o: \"\\f1c4\";\n$fa-var-file-sound-o: \"\\f1c7\";\n$fa-var-file-text: \"\\f15c\";\n$fa-var-file-text-o: \"\\f0f6\";\n$fa-var-file-video-o: \"\\f1c8\";\n$fa-var-file-word-o: \"\\f1c2\";\n$fa-var-file-zip-o: \"\\f1c6\";\n$fa-var-files-o: \"\\f0c5\";\n$fa-var-film: \"\\f008\";\n$fa-var-filter: \"\\f0b0\";\n$fa-var-fire: \"\\f06d\";\n$fa-var-fire-extinguisher: \"\\f134\";\n$fa-var-flag: \"\\f024\";\n$fa-var-flag-checkered: \"\\f11e\";\n$fa-var-flag-o: \"\\f11d\";\n$fa-var-flash: \"\\f0e7\";\n$fa-var-flask: \"\\f0c3\";\n$fa-var-flickr: \"\\f16e\";\n$fa-var-floppy-o: \"\\f0c7\";\n$fa-var-folder: \"\\f07b\";\n$fa-var-folder-o: \"\\f114\";\n$fa-var-folder-open: \"\\f07c\";\n$fa-var-folder-open-o: \"\\f115\";\n$fa-var-font: \"\\f031\";\n$fa-var-forumbee: \"\\f211\";\n$fa-var-forward: \"\\f04e\";\n$fa-var-foursquare: \"\\f180\";\n$fa-var-frown-o: \"\\f119\";\n$fa-var-futbol-o: \"\\f1e3\";\n$fa-var-gamepad: \"\\f11b\";\n$fa-var-gavel: \"\\f0e3\";\n$fa-var-gbp: \"\\f154\";\n$fa-var-ge: \"\\f1d1\";\n$fa-var-gear: \"\\f013\";\n$fa-var-gears: \"\\f085\";\n$fa-var-genderless: \"\\f1db\";\n$fa-var-gift: \"\\f06b\";\n$fa-var-git: \"\\f1d3\";\n$fa-var-git-square: \"\\f1d2\";\n$fa-var-github: \"\\f09b\";\n$fa-var-github-alt: \"\\f113\";\n$fa-var-github-square: \"\\f092\";\n$fa-var-gittip: \"\\f184\";\n$fa-var-glass: \"\\f000\";\n$fa-var-globe: \"\\f0ac\";\n$fa-var-google: \"\\f1a0\";\n$fa-var-google-plus: \"\\f0d5\";\n$fa-var-google-plus-square: \"\\f0d4\";\n$fa-var-google-wallet: \"\\f1ee\";\n$fa-var-graduation-cap: \"\\f19d\";\n$fa-var-gratipay: \"\\f184\";\n$fa-var-group: \"\\f0c0\";\n$fa-var-h-square: \"\\f0fd\";\n$fa-var-hacker-news: \"\\f1d4\";\n$fa-var-hand-o-down: \"\\f0a7\";\n$fa-var-hand-o-left: \"\\f0a5\";\n$fa-var-hand-o-right: \"\\f0a4\";\n$fa-var-hand-o-up: \"\\f0a6\";\n$fa-var-hdd-o: \"\\f0a0\";\n$fa-var-header: \"\\f1dc\";\n$fa-var-headphones: \"\\f025\";\n$fa-var-heart: \"\\f004\";\n$fa-var-heart-o: \"\\f08a\";\n$fa-var-heartbeat: \"\\f21e\";\n$fa-var-history: \"\\f1da\";\n$fa-var-home: \"\\f015\";\n$fa-var-hospital-o: \"\\f0f8\";\n$fa-var-hotel: \"\\f236\";\n$fa-var-html5: \"\\f13b\";\n$fa-var-ils: \"\\f20b\";\n$fa-var-image: \"\\f03e\";\n$fa-var-inbox: \"\\f01c\";\n$fa-var-indent: \"\\f03c\";\n$fa-var-info: \"\\f129\";\n$fa-var-info-circle: \"\\f05a\";\n$fa-var-inr: \"\\f156\";\n$fa-var-instagram: \"\\f16d\";\n$fa-var-institution: \"\\f19c\";\n$fa-var-ioxhost: \"\\f208\";\n$fa-var-italic: \"\\f033\";\n$fa-var-joomla: \"\\f1aa\";\n$fa-var-jpy: \"\\f157\";\n$fa-var-jsfiddle: \"\\f1cc\";\n$fa-var-key: \"\\f084\";\n$fa-var-keyboard-o: \"\\f11c\";\n$fa-var-krw: \"\\f159\";\n$fa-var-language: \"\\f1ab\";\n$fa-var-laptop: \"\\f109\";\n$fa-var-lastfm: \"\\f202\";\n$fa-var-lastfm-square: \"\\f203\";\n$fa-var-leaf: \"\\f06c\";\n$fa-var-leanpub: \"\\f212\";\n$fa-var-legal: \"\\f0e3\";\n$fa-var-lemon-o: \"\\f094\";\n$fa-var-level-down: \"\\f149\";\n$fa-var-level-up: \"\\f148\";\n$fa-var-life-bouy: \"\\f1cd\";\n$fa-var-life-buoy: \"\\f1cd\";\n$fa-var-life-ring: \"\\f1cd\";\n$fa-var-life-saver: \"\\f1cd\";\n$fa-var-lightbulb-o: \"\\f0eb\";\n$fa-var-line-chart: \"\\f201\";\n$fa-var-link: \"\\f0c1\";\n$fa-var-linkedin: \"\\f0e1\";\n$fa-var-linkedin-square: \"\\f08c\";\n$fa-var-linux: \"\\f17c\";\n$fa-var-list: \"\\f03a\";\n$fa-var-list-alt: \"\\f022\";\n$fa-var-list-ol: \"\\f0cb\";\n$fa-var-list-ul: \"\\f0ca\";\n$fa-var-location-arrow: \"\\f124\";\n$fa-var-lock: \"\\f023\";\n$fa-var-long-arrow-down: \"\\f175\";\n$fa-var-long-arrow-left: \"\\f177\";\n$fa-var-long-arrow-right: \"\\f178\";\n$fa-var-long-arrow-up: \"\\f176\";\n$fa-var-magic: \"\\f0d0\";\n$fa-var-magnet: \"\\f076\";\n$fa-var-mail-forward: \"\\f064\";\n$fa-var-mail-reply: \"\\f112\";\n$fa-var-mail-reply-all: \"\\f122\";\n$fa-var-male: \"\\f183\";\n$fa-var-map-marker: \"\\f041\";\n$fa-var-mars: \"\\f222\";\n$fa-var-mars-double: \"\\f227\";\n$fa-var-mars-stroke: \"\\f229\";\n$fa-var-mars-stroke-h: \"\\f22b\";\n$fa-var-mars-stroke-v: \"\\f22a\";\n$fa-var-maxcdn: \"\\f136\";\n$fa-var-meanpath: \"\\f20c\";\n$fa-var-medium: \"\\f23a\";\n$fa-var-medkit: \"\\f0fa\";\n$fa-var-meh-o: \"\\f11a\";\n$fa-var-mercury: \"\\f223\";\n$fa-var-microphone: \"\\f130\";\n$fa-var-microphone-slash: \"\\f131\";\n$fa-var-minus: \"\\f068\";\n$fa-var-minus-circle: \"\\f056\";\n$fa-var-minus-square: \"\\f146\";\n$fa-var-minus-square-o: \"\\f147\";\n$fa-var-mobile: \"\\f10b\";\n$fa-var-mobile-phone: \"\\f10b\";\n$fa-var-money: \"\\f0d6\";\n$fa-var-moon-o: \"\\f186\";\n$fa-var-mortar-board: \"\\f19d\";\n$fa-var-motorcycle: \"\\f21c\";\n$fa-var-music: \"\\f001\";\n$fa-var-navicon: \"\\f0c9\";\n$fa-var-neuter: \"\\f22c\";\n$fa-var-newspaper-o: \"\\f1ea\";\n$fa-var-openid: \"\\f19b\";\n$fa-var-outdent: \"\\f03b\";\n$fa-var-pagelines: \"\\f18c\";\n$fa-var-paint-brush: \"\\f1fc\";\n$fa-var-paper-plane: \"\\f1d8\";\n$fa-var-paper-plane-o: \"\\f1d9\";\n$fa-var-paperclip: \"\\f0c6\";\n$fa-var-paragraph: \"\\f1dd\";\n$fa-var-paste: \"\\f0ea\";\n$fa-var-pause: \"\\f04c\";\n$fa-var-paw: \"\\f1b0\";\n$fa-var-paypal: \"\\f1ed\";\n$fa-var-pencil: \"\\f040\";\n$fa-var-pencil-square: \"\\f14b\";\n$fa-var-pencil-square-o: \"\\f044\";\n$fa-var-phone: \"\\f095\";\n$fa-var-phone-square: \"\\f098\";\n$fa-var-photo: \"\\f03e\";\n$fa-var-picture-o: \"\\f03e\";\n$fa-var-pie-chart: \"\\f200\";\n$fa-var-pied-piper: \"\\f1a7\";\n$fa-var-pied-piper-alt: \"\\f1a8\";\n$fa-var-pinterest: \"\\f0d2\";\n$fa-var-pinterest-p: \"\\f231\";\n$fa-var-pinterest-square: \"\\f0d3\";\n$fa-var-plane: \"\\f072\";\n$fa-var-play: \"\\f04b\";\n$fa-var-play-circle: \"\\f144\";\n$fa-var-play-circle-o: \"\\f01d\";\n$fa-var-plug: \"\\f1e6\";\n$fa-var-plus: \"\\f067\";\n$fa-var-plus-circle: \"\\f055\";\n$fa-var-plus-square: \"\\f0fe\";\n$fa-var-plus-square-o: \"\\f196\";\n$fa-var-power-off: \"\\f011\";\n$fa-var-print: \"\\f02f\";\n$fa-var-puzzle-piece: \"\\f12e\";\n$fa-var-qq: \"\\f1d6\";\n$fa-var-qrcode: \"\\f029\";\n$fa-var-question: \"\\f128\";\n$fa-var-question-circle: \"\\f059\";\n$fa-var-quote-left: \"\\f10d\";\n$fa-var-quote-right: \"\\f10e\";\n$fa-var-ra: \"\\f1d0\";\n$fa-var-random: \"\\f074\";\n$fa-var-rebel: \"\\f1d0\";\n$fa-var-recycle: \"\\f1b8\";\n$fa-var-reddit: \"\\f1a1\";\n$fa-var-reddit-square: \"\\f1a2\";\n$fa-var-refresh: \"\\f021\";\n$fa-var-remove: \"\\f00d\";\n$fa-var-renren: \"\\f18b\";\n$fa-var-reorder: \"\\f0c9\";\n$fa-var-repeat: \"\\f01e\";\n$fa-var-reply: \"\\f112\";\n$fa-var-reply-all: \"\\f122\";\n$fa-var-retweet: \"\\f079\";\n$fa-var-rmb: \"\\f157\";\n$fa-var-road: \"\\f018\";\n$fa-var-rocket: \"\\f135\";\n$fa-var-rotate-left: \"\\f0e2\";\n$fa-var-rotate-right: \"\\f01e\";\n$fa-var-rouble: \"\\f158\";\n$fa-var-rss: \"\\f09e\";\n$fa-var-rss-square: \"\\f143\";\n$fa-var-rub: \"\\f158\";\n$fa-var-ruble: \"\\f158\";\n$fa-var-rupee: \"\\f156\";\n$fa-var-save: \"\\f0c7\";\n$fa-var-scissors: \"\\f0c4\";\n$fa-var-search: \"\\f002\";\n$fa-var-search-minus: \"\\f010\";\n$fa-var-search-plus: \"\\f00e\";\n$fa-var-sellsy: \"\\f213\";\n$fa-var-send: \"\\f1d8\";\n$fa-var-send-o: \"\\f1d9\";\n$fa-var-server: \"\\f233\";\n$fa-var-share: \"\\f064\";\n$fa-var-share-alt: \"\\f1e0\";\n$fa-var-share-alt-square: \"\\f1e1\";\n$fa-var-share-square: \"\\f14d\";\n$fa-var-share-square-o: \"\\f045\";\n$fa-var-shekel: \"\\f20b\";\n$fa-var-sheqel: \"\\f20b\";\n$fa-var-shield: \"\\f132\";\n$fa-var-ship: \"\\f21a\";\n$fa-var-shirtsinbulk: \"\\f214\";\n$fa-var-shopping-cart: \"\\f07a\";\n$fa-var-sign-in: \"\\f090\";\n$fa-var-sign-out: \"\\f08b\";\n$fa-var-signal: \"\\f012\";\n$fa-var-simplybuilt: \"\\f215\";\n$fa-var-sitemap: \"\\f0e8\";\n$fa-var-skyatlas: \"\\f216\";\n$fa-var-skype: \"\\f17e\";\n$fa-var-slack: \"\\f198\";\n$fa-var-sliders: \"\\f1de\";\n$fa-var-slideshare: \"\\f1e7\";\n$fa-var-smile-o: \"\\f118\";\n$fa-var-soccer-ball-o: \"\\f1e3\";\n$fa-var-sort: \"\\f0dc\";\n$fa-var-sort-alpha-asc: \"\\f15d\";\n$fa-var-sort-alpha-desc: \"\\f15e\";\n$fa-var-sort-amount-asc: \"\\f160\";\n$fa-var-sort-amount-desc: \"\\f161\";\n$fa-var-sort-asc: \"\\f0de\";\n$fa-var-sort-desc: \"\\f0dd\";\n$fa-var-sort-down: \"\\f0dd\";\n$fa-var-sort-numeric-asc: \"\\f162\";\n$fa-var-sort-numeric-desc: \"\\f163\";\n$fa-var-sort-up: \"\\f0de\";\n$fa-var-soundcloud: \"\\f1be\";\n$fa-var-space-shuttle: \"\\f197\";\n$fa-var-spinner: \"\\f110\";\n$fa-var-spoon: \"\\f1b1\";\n$fa-var-spotify: \"\\f1bc\";\n$fa-var-square: \"\\f0c8\";\n$fa-var-square-o: \"\\f096\";\n$fa-var-stack-exchange: \"\\f18d\";\n$fa-var-stack-overflow: \"\\f16c\";\n$fa-var-star: \"\\f005\";\n$fa-var-star-half: \"\\f089\";\n$fa-var-star-half-empty: \"\\f123\";\n$fa-var-star-half-full: \"\\f123\";\n$fa-var-star-half-o: \"\\f123\";\n$fa-var-star-o: \"\\f006\";\n$fa-var-steam: \"\\f1b6\";\n$fa-var-steam-square: \"\\f1b7\";\n$fa-var-step-backward: \"\\f048\";\n$fa-var-step-forward: \"\\f051\";\n$fa-var-stethoscope: \"\\f0f1\";\n$fa-var-stop: \"\\f04d\";\n$fa-var-street-view: \"\\f21d\";\n$fa-var-strikethrough: \"\\f0cc\";\n$fa-var-stumbleupon: \"\\f1a4\";\n$fa-var-stumbleupon-circle: \"\\f1a3\";\n$fa-var-subscript: \"\\f12c\";\n$fa-var-subway: \"\\f239\";\n$fa-var-suitcase: \"\\f0f2\";\n$fa-var-sun-o: \"\\f185\";\n$fa-var-superscript: \"\\f12b\";\n$fa-var-support: \"\\f1cd\";\n$fa-var-table: \"\\f0ce\";\n$fa-var-tablet: \"\\f10a\";\n$fa-var-tachometer: \"\\f0e4\";\n$fa-var-tag: \"\\f02b\";\n$fa-var-tags: \"\\f02c\";\n$fa-var-tasks: \"\\f0ae\";\n$fa-var-taxi: \"\\f1ba\";\n$fa-var-tencent-weibo: \"\\f1d5\";\n$fa-var-terminal: \"\\f120\";\n$fa-var-text-height: \"\\f034\";\n$fa-var-text-width: \"\\f035\";\n$fa-var-th: \"\\f00a\";\n$fa-var-th-large: \"\\f009\";\n$fa-var-th-list: \"\\f00b\";\n$fa-var-thumb-tack: \"\\f08d\";\n$fa-var-thumbs-down: \"\\f165\";\n$fa-var-thumbs-o-down: \"\\f088\";\n$fa-var-thumbs-o-up: \"\\f087\";\n$fa-var-thumbs-up: \"\\f164\";\n$fa-var-ticket: \"\\f145\";\n$fa-var-times: \"\\f00d\";\n$fa-var-times-circle: \"\\f057\";\n$fa-var-times-circle-o: \"\\f05c\";\n$fa-var-tint: \"\\f043\";\n$fa-var-toggle-down: \"\\f150\";\n$fa-var-toggle-left: \"\\f191\";\n$fa-var-toggle-off: \"\\f204\";\n$fa-var-toggle-on: \"\\f205\";\n$fa-var-toggle-right: \"\\f152\";\n$fa-var-toggle-up: \"\\f151\";\n$fa-var-train: \"\\f238\";\n$fa-var-transgender: \"\\f224\";\n$fa-var-transgender-alt: \"\\f225\";\n$fa-var-trash: \"\\f1f8\";\n$fa-var-trash-o: \"\\f014\";\n$fa-var-tree: \"\\f1bb\";\n$fa-var-trello: \"\\f181\";\n$fa-var-trophy: \"\\f091\";\n$fa-var-truck: \"\\f0d1\";\n$fa-var-try: \"\\f195\";\n$fa-var-tty: \"\\f1e4\";\n$fa-var-tumblr: \"\\f173\";\n$fa-var-tumblr-square: \"\\f174\";\n$fa-var-turkish-lira: \"\\f195\";\n$fa-var-twitch: \"\\f1e8\";\n$fa-var-twitter: \"\\f099\";\n$fa-var-twitter-square: \"\\f081\";\n$fa-var-umbrella: \"\\f0e9\";\n$fa-var-underline: \"\\f0cd\";\n$fa-var-undo: \"\\f0e2\";\n$fa-var-university: \"\\f19c\";\n$fa-var-unlink: \"\\f127\";\n$fa-var-unlock: \"\\f09c\";\n$fa-var-unlock-alt: \"\\f13e\";\n$fa-var-unsorted: \"\\f0dc\";\n$fa-var-upload: \"\\f093\";\n$fa-var-usd: \"\\f155\";\n$fa-var-user: \"\\f007\";\n$fa-var-user-md: \"\\f0f0\";\n$fa-var-user-plus: \"\\f234\";\n$fa-var-user-secret: \"\\f21b\";\n$fa-var-user-times: \"\\f235\";\n$fa-var-users: \"\\f0c0\";\n$fa-var-venus: \"\\f221\";\n$fa-var-venus-double: \"\\f226\";\n$fa-var-venus-mars: \"\\f228\";\n$fa-var-viacoin: \"\\f237\";\n$fa-var-video-camera: \"\\f03d\";\n$fa-var-vimeo-square: \"\\f194\";\n$fa-var-vine: \"\\f1ca\";\n$fa-var-vk: \"\\f189\";\n$fa-var-volume-down: \"\\f027\";\n$fa-var-volume-off: \"\\f026\";\n$fa-var-volume-up: \"\\f028\";\n$fa-var-warning: \"\\f071\";\n$fa-var-wechat: \"\\f1d7\";\n$fa-var-weibo: \"\\f18a\";\n$fa-var-weixin: \"\\f1d7\";\n$fa-var-whatsapp: \"\\f232\";\n$fa-var-wheelchair: \"\\f193\";\n$fa-var-wifi: \"\\f1eb\";\n$fa-var-windows: \"\\f17a\";\n$fa-var-won: \"\\f159\";\n$fa-var-wordpress: \"\\f19a\";\n$fa-var-wrench: \"\\f0ad\";\n$fa-var-xing: \"\\f168\";\n$fa-var-xing-square: \"\\f169\";\n$fa-var-yahoo: \"\\f19e\";\n$fa-var-yelp: \"\\f1e9\";\n$fa-var-yen: \"\\f157\";\n$fa-var-youtube: \"\\f167\";\n$fa-var-youtube-play: \"\\f16a\";\n$fa-var-youtube-square: \"\\f166\";\n\n","header {\n    padding-bottom: $padding-base-vertical;\n    background-color: $text-color;\n    color: white;\n}\n\n.title {\n    float: right;\n    text-align: right;\n    margin: 0;\n\n    @media screen and (max-width: $screen-xs-max) {\n      float: none;\n      text-align: center;\n    }\n}\n\n.title h1, .title h2 {\n    margin: $padding-small-vertical 0;\n    line-height: 1;\n}\n\n.title h1 {\n    padding: $padding-small-vertical 0;\n    color: $easy-white;\n}\n\n.title h2 {\n    padding: $padding-small-vertical $padding-base-vertical;\n    font-weight: normal;\n}\n\n\nheader .contact {\n    float: left;\n    margin: 0;\n    padding-left: $padding-large-horizontal;\n    @media print and (max-width: $screen-xs-max) {\n      float: none;\n      margin-top: $padding-large-vertical;\n      padding-left: $padding-xs-horizontal;\n    }\n}\n\nheader .contact li {\n    list-style-type: none;\n    font-style: normal;\n    line-height: 1.4;\n    font-size: $font-size-medium;\n    word-break: break-all;\n}\n\nheader a:link, header a:visited {\n    color: $easy-white;\n}\n\n\nheader a:hover, header a:active {\n    color: $light-color;\n}\n\n\n","footer {\n    text-align: center;\n    margin: $padding-container-vertical $padding-base-vertical;\n}","$sec-icon-size: 32px;\n$sec-icon-padding: 6px;\n\nsection {\n  margin-bottom: $padding-huge-vertical;\n};\n\n.sec-title-wrapper{\n  @include float-container;\n}\n\n.sec-title{\n  float: left;\n  padding: 0;\n  margin: 0 0 0 $padding-small-horizontal;\n  @include float-container;\n}\n\n.sec-title-ch {\n  font-size: $font-size-large;\n  float: left;\n  font-weight: bold;\n}\n\n.sec-title-en {\n  font-size: $font-size-base;\n  float: left;\n  clear: left;\n  color: $bright-color;\n  font-variant: small-caps;\n  font-weight: bold;\n}\n@mixin fa-sec-icon($content){\n  @include fa-icon($sec-icon-size, $sec-icon-padding, $text-color);\n  content: $content;\n}\n.sec-title-wrapper::before {\n  @include fa-sec-icon($fa-var-github-square)\n}\n@mixin set-section-icon($section-name, $content){\n  .#{$section-name} .sec-title-wrapper::before{\n    content: $content;\n  }\n}\n\n",".education-name {\n  font-size: $font-size-huge;\n  font-weight: bold;\n  margin: $padding-large-vertical 0 $padding-small-vertical 0 ;\n}\n\n.education-major,\n.education-honor {\n  list-style-type: none;\n  line-height: $line-height-base;\n  margin: 0;\n  padding: 0;\n}\n@include set-section-icon(education, $fa-var-book);\n\n.education-major {\n  @include set-li-icon($fa-var-graduation-cap);\n}\n.education-honor {\n  \n  @include set-li-icon($fa-var-trophy);\n}"],"sourceRoot":"webpack://"}]);
